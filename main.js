...
if (payout == 0) {
    ...
    if (payout == 25000) {
        displayPayout.innerHTML = `Congratulations! You\'ve won 
                                    $${payout} a YEAR for LIFE!`;
    } else if (payout == 7000) {
        displayPayout.innerHTML = `Congratulations! You\'ve won 
                                    $${payout} a WEEK for LIFE!`;
    } else {
        displayPayout.innerHTML = `Congratulations! You\'ve won $${payout}!`;
    }
}
